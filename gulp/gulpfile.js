 ...
 */
const watchFiles = () => {
    gulp.watch(devPath.scss, gulp.series(cssSass))
    gulp.watch(devPath.html, gulp.series(html, browserSyncReload))
}
